  ...
  <div class="page-layout qui-fx-ver">
    ...
    <table-list :page-list="pageList" :columns="columns" :table-list="dataList">
      <template v-slot:actions="action">
        ...
        <a-tag v-if="action.record.state === '2'" color="#2db7f5" @click="uploadScore">录入成绩</a-tag>
      </template>
      ...
      <template v-slot:other2="other2">
        <a-tag v-if="other2.record.state === '2'" color="#2db7f5" @click="seeScore">查看成绩</a-tag>
        <div v-if="other2.record.state === '2' && false" class="u-content-color">未录入</div>
      </template>
