<template>
  <div id="tableList" class="qui-fx-f1" style="overflow: hidden">
    <a-table
      ...
      <template slot="countNum" slot-scope="text, record">
        <slot name="countNums" :record="record"></slot>
      </template>
      <template slot="editClassRoom" slot-scope="text, record">
        <slot name="editClassRooms" :record="record"></slot>
      </template>
