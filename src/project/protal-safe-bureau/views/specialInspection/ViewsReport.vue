<template>
  <div class="add-find page-layout bg-fff content pos-box qui-fx-ver">
    <div class="title u-fx-ac-jc wh u-bold u-font-1 u-mar-b10">《{{ name }}》检查情况报告</div>
    <div class="time u-fx-ac-jc u-font-01">{{ time }}</div>
    <div class="list-box wh u-mar-20 ">
    ...
    <div class="list-box wh u-mar-20 ">
      ...
      <div class="list-cont wh u-fx u-mar-t20">
    ...
    <div class="table-list-box wh u-mar-20 ">
      <div class="list-title u-fx-ac-jc u-bold">
        一、安全隐患明细表
      </div>
      <div class="list-cont wh  u-fx-wp u-mar-t20">
        <a-table :columns="columns" :pagination="false" :data-source="dangerSchool" bordered>
        </a-table>
      </div>
    </div>
    <div class="table-list-box1 wh u-mar-20 ">
      <div class="list-title u-fx-ac-jc u-bold">
        隐患数量排名
      </div>
      <!-- <no-data v-if="dangerSchool.length==0" msg="暂无隐患数量排名~">
      </no-data> -->
      <!-- v-else -->
      <div class="list-cont wh  u-fx-wp u-mar-t20">
        <table border="0" class="u-bd-1px" width="100% " cellspacing:="0">
          ...
          <tr
            ...
            :key="index">
            <td class="u-bd-l u-bd-b " align="center" valign="middle" >{{ index }}434</td>
            <td class="u-bd-l u-bd-b " align="center" valign="middle" >{{ item.schoolName }}345</td>
            <td class="u-bd-l u-bd-b u-bd-r" align="center" valign="middle">{{ item.totalCount }}4545</td>
          </tr>
          <tr>
            ...
            <td class="u-bd-l u-bd-b " align="center" valign="middle" colspan="2" rowspan="4">
              <pre-bar-echarts></pre-bar-echarts>
            </td>
          </tr>
          <tr>
            <td ></td>
