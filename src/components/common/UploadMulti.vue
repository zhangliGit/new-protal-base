...
export default {
  ...
  mounted () {
    if (this.fileInfo.url) {
      ...
      this.reqUrl = !this.isCheck ? `${hostEnv.zhangkun}/file/freeUpload?schoolCode=${this.schoolCode}` : `${hostEnv.zk_school}/file/uploadUserPhoto?schoolCode=${this.schoolCode}`
    }
  },
  computed: {
    ...mapState('home', [
