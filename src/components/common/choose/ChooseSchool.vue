  ...
  methods: {
    ...
    async getUserList() {
      ...
      const res = await $ajax.post({
        url: `${hostEnv.ljj_edu}/school/info/edu/schoolmanage/info`,
        params: req
      })
      if (!res.data) {
        return
    ...
    onFocus(value) {
      ...
      $ajax.get({
        url: `${hostEnv.zk_school}/provinces/getProvinces`
      }).then(res => {
    ...
    loadData(selectedOptions) {
      ...
      $ajax.get({
        url: `${hostEnv.zk_school}/provinces/getSubNodes/${targetOption.id}`
      }).then(res => {
